    ...
    <div className="w-72 bg-gray-900 dark:bg-gray-950 text-white h-screen flex flex-col">
      ...
      <div className="p-6 border-t border-gray-700 dark:border-gray-800">
        <div className="flex items-center space-x-3">
          ...
          >
            <div className={`w-2 h-2 rounded-full ${!isDark ? 'bg-white' : 'bg-gray-400'}`}></div>
            <span className={`text-sm ${!isDark ? 'text-white' : 'text-gray-400'}`}>Light</span>
            <div className={`w-2 h-2 rounded-full ${isDark ? 'bg-white' : 'bg-gray-400'}`}></div>
            <span className={`text-sm ${isDark ? 'text-white' : 'text-gray-400'}`}>Dark</span>
          </button>
        </div>
      </div>
    </div>
